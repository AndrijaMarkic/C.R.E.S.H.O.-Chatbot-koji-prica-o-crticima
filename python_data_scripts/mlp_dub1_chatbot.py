...
model = load_model('models/mlp_dub1_chatbot_model.h5')

with open("databases/My Little Pony Friendship is Magic/mlp_dub1.json", "r", encoding="utf8") as f:
    intents = json.load(f)
words = pickle.load(open('pkl_w/words_mlp_dub1.pkl','rb'))
labels = pickle.load(open('pkl_l/labels_mlp_dub1.pkl','rb'))
...
def chat_mlp_dub1():
    ...
    while True:
        ...
        if inp.lower() == 'quit' or inp.lower() == 'exit':
            ...
            print('\n Puštam Moj Mali Poni Uvodnu špicu sa youtube.com\n ')
