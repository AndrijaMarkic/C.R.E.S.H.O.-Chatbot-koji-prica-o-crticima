...
for line in open('databases/Conan the Adventurer/conan q-dub.txt', encoding='utf8'):
    labels.append(line.strip().split(' ')[-1])
    questions.append(' '.join(line.split(' ')[:-1]))

answers = []

for line in open('databases/Conan the Adventurer/conan a-dub.txt', encoding='utf8'):
